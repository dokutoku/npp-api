...
//
enum NOTEPAD_PLUS_VERSION = "Notepad++ v7.9.1";

// should be X.Y : ie. if VERSION_DIGITALVALUE == 4, 7, 1, 0 , then X = 4, Y = 71
// ex : #define VERSION_VALUE TEXT("5.63\0")
enum VERSION_VALUE = "7.91\0";
...
enum IDI_SAVED_ALT_ICON = 506;
enum IDI_UNSAVED_ALT_ICON = 507;
enum IDI_READONLY_ALT_ICON = 508;
...
enum NOTEPADPLUS_USER_INTERNAL = core.sys.windows.winuser.WM_USER + 0000;
	...
	enum NPPM_INTERNAL_CHANGETABBAEICONS = .NOTEPADPLUS_USER_INTERNAL + 28;
	...
	enum NPPM_INTERNAL_SCINTILLAFINDERWRAP = .NOTEPADPLUS_USER_INTERNAL + 53;
	enum NPPM_INTERNAL_MINIMIZED_TRAY = .NOTEPADPLUS_USER_INTERNAL + 54;
